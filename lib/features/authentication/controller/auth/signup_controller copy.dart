...
//   final formstateSign = GlobalKey<FormState>();
...
//   // نوع المستخدم (فرد / مكتب)
//   final userType = "user".obs; // افتراضي: فرد
//   File? thumbnail;
...
//   /// **دالة التسجيل العامة** (فرد أو مكتب)
...
//   /// **تغيير نوع المستخدم (فرد / مالك عقار)**
//   void setUserType(String type) {
//     userType.value = type;
//     update();
//   }

//   /// **الانتقال إلى صفحة تفاصيل المكتب**
//   // void getToOfficeDetails() => Get.toNamed('/OfficeDetailsScreen');
